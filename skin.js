...
// Pano2VR 6.1.2/17873
// Filename: Tossa T-116 Interior menu texto con sombras.ggsk
// Generated 2026-03-26T19:15:04
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		el.ggFilter = [];
		el.ggTagTable = [
			{tag:"Ingreso",title:"Ingreso"},
			{tag:"Cocina",title:"Cocina"},
			{tag:"SalaComedor",title:"Sala Comedor"},
			{tag:"BanoPB",title:"1\/2 Ba\xf1o"},
			{tag:"CuartoLavado",title:"Cuarto de Lavado"},
			{tag:"Patio",title:"Patio"},
			{tag:"SalaTV",title:"Sala de TV"},
			{tag:"RecPpal",title:"Recamara Ppal"},
			{tag:"Banorecppal",title:"Ba\xf1o Rec PPal"},
			{tag:"Rec02",title:"Recamara 02"},
			{tag:"Rec03",title:"Recamara 03"},
			{tag:"BanoPA",title:"Ba\xf1o PA"},
			];
		el.ggId="clone sala";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		els.innerHTML="Toss\xe1<br\/>T116";
		el.appendChild(els);
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		hs='data:image/svg+xml;base64,'+
